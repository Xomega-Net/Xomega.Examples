...
{
    public class SalesOrderHeaderInmemConfig : IEntityTypeConfiguration<SalesOrderHeaderInmem>
    {
        public void Configure(EntityTypeBuilder<SalesOrderHeaderInmem> c)
        {
            c.ToTable("SalesOrderHeader_inmem", "Sales")
