...
{
    public class SpecialOfferOndiskConfig : IEntityTypeConfiguration<SpecialOfferOndisk>
    {
        public void Configure(EntityTypeBuilder<SpecialOfferOndisk> c)
        {
            c.ToTable("SpecialOffer_ondisk", "Sales")
