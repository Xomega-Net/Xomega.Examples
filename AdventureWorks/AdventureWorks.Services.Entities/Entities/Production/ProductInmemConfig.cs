...
{
    public class ProductInmemConfig : IEntityTypeConfiguration<ProductInmem>
    {
        public void Configure(EntityTypeBuilder<ProductInmem> c)
        {
            c.ToTable("Product_inmem", "Production")
