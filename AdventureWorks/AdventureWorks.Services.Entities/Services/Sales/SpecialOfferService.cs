...
namespace AdventureWorks.Services.Entities
{
    public partial class SpecialOfferService : BaseService, ISpecialOfferService
    {
        ...
        public virtual async Task<Output<ICollection<SpecialOffer_ReadListOutput>>> ReadListAsync()
        {
            ...
            return await Task.FromResult(new Output<ICollection<SpecialOffer_ReadListOutput>>(currentErrors, res));
        }
    }
}